...
public class TeamsItem implements Parcelable {
	...
	protected TeamsItem(Parcel in) {
		...
		this.strDescriptionCN = in.readParcelable(Object.class.getClassLoader());
		...
		this.strDescriptionSE = in.readParcelable(Object.class.getClassLoader());
		this.strDescriptionJP = in.readParcelable(Object.class.getClassLoader());
		this.strDescriptionFR = in.readParcelable(Object.class.getClassLoader());
		this.strStadiumLocation = in.readString();
		this.strDescriptionNL = in.readParcelable(Object.class.getClassLoader());
		this.strCountry = in.readString();
		this.strRSS = in.readString();
		this.strDescriptionRU = in.readParcelable(Object.class.getClassLoader());
		this.strTeamBanner = in.readString();
		this.strDescriptionNO = in.readParcelable(Object.class.getClassLoader());
		this.strStadiumThumb = in.readString();
		this.strDescriptionES = in.readParcelable(Object.class.getClassLoader());
		...
		this.strDescriptionIL = in.readParcelable(Object.class.getClassLoader());
		this.strLocked = in.readString();
		this.strAlternate = in.readString();
		this.strTeam = in.readString();
		this.strTwitter = in.readString();
		this.strDescriptionHU = in.readParcelable(Object.class.getClassLoader());
		this.strGender = in.readString();
		this.strDivision = in.readParcelable(Object.class.getClassLoader());
		this.strStadium = in.readString();
		this.strFacebook = in.readString();
		this.strTeamBadge = in.readString();
		this.strDescriptionPT = in.readParcelable(Object.class.getClassLoader());
		...
		this.strDescriptionPL = in.readParcelable(Object.class.getClassLoader());
	}

	public static final Parcelable.Creator<TeamsItem> CREATOR = new Parcelable.Creator<TeamsItem>() {
		@Override
		public TeamsItem createFromParcel(Parcel source) {
			return new TeamsItem(source);
		}
